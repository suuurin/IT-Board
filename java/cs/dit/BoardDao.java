...
public class BoardDao {
    ...
    public void deleteQBoard(String regdate) {
        String sql = "DELETE FROM qboard WHERE regdate=?";
        try (Connection con = getConnection();
             PreparedStatement pstmt = con.prepareStatement(sql)) {
            pstmt.setString(1, regdate);
    ...
    public void deleteSBoard(String regdate) {
        String sql = "DELETE FROM sboard WHERE regdate=?";
        try (Connection con = getConnection();
             PreparedStatement pstmt = con.prepareStatement(sql)) {
            pstmt.setString(1, regdate);
    ...
    public void deleteTBoard(String regdate) {
        String sql = "DELETE FROM tboard WHERE regdate=?";
        try (Connection con = getConnection();
             PreparedStatement pstmt = con.prepareStatement(sql)) {
            pstmt.setString(1, regdate);
